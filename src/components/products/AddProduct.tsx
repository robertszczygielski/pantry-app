...
export const AddProduct: React.FC = () => {
  ...
  const initialValues: IFormValues = {name: "", amount: "", category: ""};
        ...
        >
          {() => (
              <Form>
                ...
                {validationError.errorType === ErrorType.PANTRY_PRODUCT_NAME_NO_SMALL_LETTER &&
                <DangerMessage message={validationError.errorCode}/>}

                <label htmlFor="name">Amount</label>
                <Field className="form-control" type="text" name="amount"/>
                {validationError.errorType === ErrorType.PANTRY_PRODUCT_AMOUNT_GREATER_THAN_ZERO &&
                <DangerMessage message={validationError.errorCode}/>}
